...
위빙 용접의 종류로는 위빙 직선용접, 위빙 곡선운전, 위빙 전환곡선운전, 다중위빙직선용접이 있으며, 교시방법은 앞의 5.2.1 \~5.2.5 까지의 일반 용접동작과 동일합니다.
...
> *   위빙 조건 설정
>
>     위빙의 길이, 너비, 구간 도달 시간 등 위빙에 필요한 수치를 조절하는 창입니다.\
>     위빙방식에 따라 창으로 수정 목록이 변경됩니다.
