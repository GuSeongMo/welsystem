...
티칭 팬던트의 오른쪽에 있는 버튼을 조작하여 교시 위치로 이동할 수 있습니다.\
조작 방법에는 Joint, Global, Local 세 가지 방법이 있습니다.

<figure><img src="../.gitbook/assets/2025-04-02 14 00 47.png" alt=""><figcaption><p>＜티칭팬던트의 수동조작버튼＞</p></figcaption></figure>

* F1(좌표계 전환 버튼): 버튼을 누르면 좌표계를 전환할 수 있습니다.

<table><thead><tr><th width="66"></th><th width="197"></th><th></th></tr></thead><tbody><tr><td><img src="../icon/joint.ax.png" alt=""></td><td>Joint</td><td>로봇의 각 관절을 움직이는 좌표계</td></tr><tr><td><img src="../icon/global.ax.png" alt=""></td><td>Global</td><td>로봇 중심을 기준으로 가로, 세로, 수직으로 움직이는 좌표계</td></tr><tr><td><img src="../icon/tool.ax.png" alt=""></td><td>Tool</td><td>로봇 TCP(Tool Center Point)를 기준으로 가로, 세로로 수직으로 움직이는 좌표계</td></tr></tbody></table>

* F2(수동 속도 전환 버튼): 버튼을 누르면 3개의 속도(저속, 중속, 고속)로 전환할 수   있습니다.
...
* 1± \~ 3± / X± \~ Z± (수동 조작 버튼1)\
  (용접 프로그램 동작 중인 경우 "용접중"기능의 "용접중위치 조작 기능"에도 사용됩니다.)
...
*   EX 1± \~ 2±(부가축 수동 조작 버튼) \
    부가축 1±, 2±에 대한 수동 조작 버튼은 부가축을 적용했을 때 유효합니다.

    (용접 프로그램 동작 중인 경우 "용접중"기능의 "용접중 조건 변경 기능"에도 사용됩니다.)
