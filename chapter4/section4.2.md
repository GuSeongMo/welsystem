...
<figure><img src="../.gitbook/assets/2025-04-04 09 35 46.png" alt=""><figcaption></figcaption></figure>

> 1. 이동\
>    용접 이외의 로봇 이동에 필요한 동작을 추가합니다.
> 2. 동작 변환\
>    다양한 용접 방법이나 조건 등을 추가할 수 있습니다.\
>    위의 방향키를 눌러 페이지를 전환할 수 있습니다.
> 3. 프로그램 창\
...
> 10. 프로그램 작동 속도 조절 바
>
>     프로그램이 동작하고 있을 때, 용접 모션 이외의 속도를 조정할 수 있습니다.
>
>     속도 조절 막대는 총 10단계로 한 단계당 10%씩, 100%까지 올릴 수 있습니다. \
>     (용접 속도에는 반영되지 않습니다.)
> 11. 공정 선택
>
...
<figure><img src="../.gitbook/assets/2025-04-02 13 01 08 (2).png" alt=""><figcaption></figcaption></figure>
...
> 3.  교시 위치 편집
>
>     이미  교시 되어있는 위치로 이동하거나(로봇 이동, 부가축 이동) 현재 위치로 수정(위치수정)할 수 있습니다.
>
>     연속 수정의 경우, 수정을 시작할 위치의 "교시점변경"을 클릭합니다.\
>     선택 위치부터 순서대로 수정이 가능해집니다. (로봇프리 상태가 아닌 경우에만 작동합니다.)
> 4.  수동 조작 패널
>
>     로봇 프리가 아닌 상태에서 펜던트 기능과 같이 조작으로 로봇을 이동할 수 있는 패널입니다. \
...
<figure><img src="../.gitbook/assets/2025-04-02 13 01 08 (3).png" alt=""><figcaption></figcaption></figure>
...
>     프로그램을 반복 실행하는기능입니다.
>
>     프로그램을 횟수 만큼 반복하는 기능, 입력한 수치 만큼 쉬프트해서 실행하는 모드, 횟수 만큼 반복할 때마다 쉬프트하는 기능을 선택할 수 있습니다.\
>     (반복 횟수를"-1"로 설정하면 무한 반복 합니다.)
> 6.  프로그램 작동
>
